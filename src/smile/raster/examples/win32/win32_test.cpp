...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR lpCmdLine, int nCmdShow)
{
	...
	smile::Raster::objparser::Mesh mesh = smile::Raster::objparser::LoadObj("data/tuktuk.obj");

	smile::Raster::BufferID vertexBuffer = pContext->CreateVertexBuffer(
		mesh.VertexBuffer.data(),
		mesh.VertexBuffer.size(),
		sizeof(smile::Raster::objparser::Vertex) * mesh.VertexBuffer.size()
	);

	smile::Raster::BufferID indexBuffer = pContext->CreateIndexBuffer(
		mesh.IndexBuffer.data(), mesh.IndexBuffer.size()
	);
	...
	while (!g_ShouldClose)
	{
		...
		pContext->DrawIndexed(mesh.IndexBuffer.size());
