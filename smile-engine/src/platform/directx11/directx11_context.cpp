...
namespace smile::graphic
{
    ...
    void DirectX11Context::Initialize()
    {
        ...
        {
            SM_LOG_ERROR(
                "DirectXContext::Initialize > Failed to create D3D11Device: %ls", GetDirectX11ErrorMessage( result ) );
            return;
        }
        ...
        if ( FAILED( result ) )
        {
            SM_LOG_ERROR( "DirectXContext::Initialize > Failed to create depth stencil buffer: %ls",
        ...
        {
            SM_LOG_ERROR(
                "DirectXContext::Initialize > Failed to create depth stencil view: %ls", GetDirectX11ErrorMessage( result ) );
            return;
        }
        ...
        {
            SM_LOG_ERROR(
                "DirectXContext::Initialize > Failed to create render target view: %ls", GetDirectX11ErrorMessage( result ) );
            return;
        }
