...
#include "smile_engine/graphic/camera/ecs/camera_component.h"

#include "smile_engine/scripting/ecs/script_component.h"
...
#include "smile_engine/physics/ecs/character_controller_component.h"
