...
{
    Image::Image() : m_Width{ 0 }, m_Height{ 0 }, m_Format{ Format::UNKNOWN }, m_Buffer{}, m_Stride{ 0 }
    {
    }

    Image::Image( const Uint32 width, const Uint32 height, const Format format, const Byte *pData )
