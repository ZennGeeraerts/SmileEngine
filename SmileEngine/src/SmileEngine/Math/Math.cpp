...
namespace Smile::Math
{
    ...
    bool DecomposeMatrix(const DirectX::XMFLOAT4X4& transform, DirectX::XMFLOAT3& translation, DirectX::XMFLOAT3& rotation, DirectX::XMFLOAT3& scale)
    {
		...
		if (Utils::CompareFloats(localMatrix._44, 0.f))
			return false;

		// First, isolate perspective.  This is the messiest.
		if (
			Utils::CompareFloats(localMatrix._14, 0.f) ||
			Utils::CompareFloats(localMatrix._24, 0.f) ||
			Utils::CompareFloats(localMatrix._34, 0.f))
		{
		...
		if (!Utils::CompareFloats(cos(rotation.y), 0.f, 0.00001f)) 
		{
