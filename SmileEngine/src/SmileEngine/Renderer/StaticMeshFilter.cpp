...
namespace Smile
{
	DirectX::XMFLOAT4 StaticMeshFilter::m_DefaultColor = DirectX::XMFLOAT4{ 1, 0, 0, 1 };
	DirectX::XMFLOAT4 StaticMeshFilter::m_DefaultFloat4 = DirectX::XMFLOAT4{ 0, 0, 0, 0 };
	DirectX::XMFLOAT3 StaticMeshFilter::m_DefaultFloat3 = DirectX::XMFLOAT3{ 0, 0, 0 };
	DirectX::XMFLOAT2 StaticMeshFilter::m_DefaultFloat2 = DirectX::XMFLOAT2{ 0, 0 };
	DirectX::XMFLOAT4 StaticMeshFilter::m_DefaultIndices4 = DirectX::XMFLOAT4{ -1, -1, -1, -1 };
