...
namespace Smile
{
	...
	{
		XMMATRIX transform = XMMatrixMultiply(XMMatrixRotationRollPitchYaw(XMConvertToRadians(m_Rotation.x), XMConvertToRadians(m_Rotation.y), XMConvertToRadians(m_Rotation.z)), 
