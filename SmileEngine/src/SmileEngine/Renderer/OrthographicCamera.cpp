...
namespace Smile
{
	...
	{
		XMStoreFloat4x4(&m_ProjectionMatrix, XMMatrixOrthographicOffCenterLH(left, right, bottom, top, 0.1f, 2500.f));
	...
	{
		XMMATRIX transform = XMMatrixTranslation(m_Position.x, m_Position.y, m_Position.z) * XMMatrixRotationZ(XMConvertToRadians(m_Rotation));
