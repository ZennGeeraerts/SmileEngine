...
namespace Smile
{
	...
	public:
		...
		virtual void onContact(const physx::PxContactPairHeader& pairHeader, const physx::PxContactPair* pPairs, physx::PxU32 nbPairs) override;
		virtual void onTrigger(physx::PxTriggerPair* pPairs, physx::PxU32 count) override;
		virtual void onAdvance(const physx::PxRigidBody* const* ppBodyBuffer, const physx::PxTransform* pPoseBuffer, const physx::PxU32 count) override;
	};
}