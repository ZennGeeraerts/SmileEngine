...
namespace Smile
{
	...
	public:
		...
		void SetPerspectiveNearPlane(float nearPlane) { m_PerspectiveNearPlane = nearPlane; RecalculateProjectionMatrix(); }

		float GetPerspectiveFarPlane() const { return m_PerspectiveFarPlane; }
		void SetPerspectiveFarPlane(float farPlane) { m_PerspectiveFarPlane = farPlane; RecalculateProjectionMatrix(); }

		// Orthographic
		void SetOrthographicCamera(float size, float nearPlane, float farPlane);

		float GetSize() const { return m_Size; }
		void SetSize(float size) { m_Size = size; RecalculateProjectionMatrix(); }

		float GetOrthographicNearPlane() const { return m_OrthographicNearPlane; }
		void SetOrthographicNearPlane(float nearPlane) { m_OrthographicNearPlane = nearPlane; RecalculateProjectionMatrix(); }

		float GetOrthographicFarPlane() const { return m_OrthographicFarPlane; }
		void SetOrthographicFarPlane(float farPlane) { m_OrthographicFarPlane = farPlane; RecalculateProjectionMatrix(); }
